...
/* Tipos de dato */
entero |
cadena { return textColor(yychar, yylength(), new Color(148, 58, 173)); }
...
/* Sumar */
mas { return textColor(yychar, yylength(), new Color(169, 155, 129)); }

/* Restar */
menos { return textColor(yychar, yylength(), new Color(169, 155, 149)); }
